  ...
  return (
    ...
    <main className="flex-1 p-8 overflow-auto">
          ...
          <CardContent>
            ...
            <div className="mt-4 text-md text-gray-500">ChatBot Name</div>
              <input
                id="chatbotname"
              ...
              />
              <div className="mt-4 text-md text-gray-500">Website URL</div>
              <input
                id="websiteUrl"
              ...
              <div className="mt-6">
                {!modelTrain ? (
                  <div>
                    ...
                    <h3 className="mx-2 text-lg font-semibold">Received Data</h3>
                    <div className="flex-1 border-t-2 border-gray-200"></div>
                  </div>
                    <ul className="flex flex-col mt-4  space-y-2 w-full max-h-96 overflow-y-auto">
                                        {data.map((item, index) => (
                                          ...
                                          >
                                            <div className="bg-gray-100 border border-gray-400 text-gray-600 text-sm pl-3 w-full h-8 flex items-center border rounded-sm overflow-x-hidden  whitespace-nowrap text-ellipsis max-w-4xl ">{item}</div>
                                            <Button
